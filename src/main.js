import { fetchedJokes } from "../fetchen";
import { getSavedJokes, removeJoke, saveJoke } from "../savedJokes";
import "./design.scss";

console.log(await fetchedJokes());
...
function renderSavedJokes() {
  ...
  savedJokes.forEach((joke, index) => {
    html += `
            ...
            <button class="saved-joke__remove" onclick="removeSavedJokes(${index})">
              <svg
